...
from app.common.annotation.openapi_examples import CREATE_MERCHANT_EXAMPLES, CREATE_USER_EXAMPLES, UPDATE_USER_EXAMPLES, \
    REGISTER_EXAMPLES, LOGIN_EXAMPLES, CREATE_ORDER_EXAMPLES, UPDATE_ORDER_EXAMPLES
...
from app.orderdnu.order.order_model import CreateOrderRequest, UpdateOrderRequest
...
CreateOrderRequestBody = Annotated[CreateOrderRequest, Body(openapi_examples=CREATE_ORDER_EXAMPLES)]
...
UpdateOrderRequestBody = Annotated[UpdateOrderRequest, Body(openapi_examples=UPDATE_ORDER_EXAMPLES)]
